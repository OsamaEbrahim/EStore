...
namespace EStore.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductImageId,Path,ProductId")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductImageId,Path,ProductId")] ProductImage productImage)
        {
